...
class InsightsSchedulerSystemd(object):
    ...
    def active(self):
        try:
            systemctl_status = run_command_get_output(
                "systemctl is-enabled insights-client.timer"
            )
    ...
    def set_daily(self):
        ...
        try:
            ...
            systemctl_timer = run_command_get_output(
    ...
    def remove_scheduling(self):
        ...
        try:
            ...
            systemctl_timer = run_command_get_output(
                "systemctl disable insights-client.timer"
            )
            systemctl_timer = run_command_get_output(
                "systemctl stop insights-client.timer"
            )
