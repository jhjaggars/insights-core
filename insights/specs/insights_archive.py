...
class InsightsArchiveSpecs(Specs):
    ...
    lvs_noheadings = simple_file(
        "insights_commands/lvs_--nameprefixes_--noheadings_--separator_-a_-o_lv_name_lv_size_lv_attr_mirror_log_vg_name_devices_region_size_data_percent_metadata_percent_--config_global_locking_type_0"
    )
    lvs_noheadings_all = simple_file(
        "insights_commands/lvs_--nameprefixes_--noheadings_--separator_-a_-o_lv_name_lv_size_lv_attr_mirror_log_vg_name_devices_region_size_data_percent_metadata_percent_--config_global_locking_type_0_devices_filter_a"
    )
    md5chk_files = simple_file(
        "insights_commands/ls_-H_.usr.lib_._libfreeblpriv3.so_libsoftokn3.so_.etc.pki.product_.69.pem_.etc.fonts.fonts.conf_.dev.null_2_.dev.null"
    )
    ...
    saphostctl_getcimobject_sapinstance = simple_file(
        "insights_commands/saphostctrl_-function_GetCIMObject_-enuminstances_SAPInstance"
    )
