...
def test_ls_var_tmp():
    ...
    assert ls_var_tmp.dirs_of("/var/tmp") == [
        "a1",
        "a2",
        "foreman-ssh-cmd-fc3f65c9-2b35-480d-87e3-1d971433d6ad",
    ]
    foreman = ls_var_tmp.dir_entry(
...
def test_ls_var_tmp_doc_examples():
    env = {"LsVarTmp": LsVarTmp, "ls_var_tmp": LsVarTmp(context_wrap(LS_VAR_TMP))}
