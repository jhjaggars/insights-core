...
def test_ls_disk():
    ...
    assert ls_disk.listing_of("/dev/disk/by-uuid") == {
        "7b0068d4-1399-4ce7-a54a-3e2fc1232299": {
            "group": "root",
            "name": "7b0068d4-1399-4ce7-a54a-3e2fc1232299",
            "links": 1,
            "perms": "rwxrwxrwx.",
        ...
        "3ab50b34-d0b9-4518-9f21-05307d895f81": {
            "group": "root",
            "name": "3ab50b34-d0b9-4518-9f21-05307d895f81",
            "links": 1,
            "perms": "rwxrwxrwx.",
            "dir": "/dev/disk/by-uuid",
        ...
        "51c5cf12-a577-441e-89da-bc93a73a1ba3": {
            "group": "root",
            "name": "51c5cf12-a577-441e-89da-bc93a73a1ba3",
            "links": 1,
            "perms": "rwxrwxrwx.",
            "dir": "/dev/disk/by-uuid",
    ...
    assert ls_disk.listings.get("/dev/disk/by-uuid")["files"] == [
        "3ab50b34-d0b9-4518-9f21-05307d895f81",
        "51c5cf12-a577-441e-89da-bc93a73a1ba3",
        "7b0068d4-1399-4ce7-a54a-3e2fc1232299",
    ]
    ...
    assert (
        ls_disk.listings.get("/dev/disk/by-uuid")["entries"][
            "3ab50b34-d0b9-4518-9f21-05307d895f81"
        ]["link"]
        == "../../dm-1"
    )
