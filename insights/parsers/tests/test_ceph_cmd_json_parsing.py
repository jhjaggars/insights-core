from insights.parsers.ceph_cmd_json_parsing import (
    CephOsdDump,
    CephOsdDf,
    CephS,
    CephECProfileGet,
...
class TestCephS:
    def test_ceph_s(self):
        ...
        assert result.data == {
            "health": {},
            "pgmap": {
                "pgs_by_state": [{"state_name": "active+clean", "count": 1800}],
                "version": 314179,
                "num_pgs": 1800,
                "data_bytes": 7943926574,
                "bytes_used": 24405610496,
...
class TestCephHealthDetail:
    def test_ceph_health_detail(self):
        ...
        assert result.data == {
            "health": {},
            "timechecks": {"epoch": 4, "round": 0, "round_status": "finished"},
            "summary": [],
            "overall_status": "HEALTH_OK",
            "detail": [],
        }
