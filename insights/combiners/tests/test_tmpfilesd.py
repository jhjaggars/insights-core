...
def test_all_tmpfiles_conf():
    ...
    assert all_data.active_rules["/etc/tmpfiles.d/sap.conf"] == [
        {
            "type": "x",
            "path": "/tmp/.sap*",
            "age": None,
    ...
    assert all_data.active_rules["/etc/tmpfiles.d/dnf.conf"] == [
        {
            "type": "r!",
            "path": "/var/cache/dnf/*/*/download_lock.pid",
            "age": None,
            "gid": None,
            "uid": None,
            "argument": None,
    ...
    assert all_data.find_file("/tmp/.sap*") == {
        SAP_PATH: {
            "type": "x",
            "path": "/tmp/.sap*",
            "age": None,
    ...
    assert len(all_data.active_rules) == 2
    assert all_data.active_rules["/etc/tmpfiles.d/sap.conf"][0] == {
        "type": "x",
        "path": "/tmp/.sap*",
        "age": None,
        "gid": None,
