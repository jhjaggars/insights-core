...
CASES = [
    # noqa
    # RHEL7 not disabled
    (7, Case(CMDLINE_NOT_DISABLED, None, None, SYSCTL_NOT_DISABLED), (False, set())),
    # RHEL7 disabled via cmdline
    (
        7,
        Case(CMDLINE_DISABLED, None, None, SYSCTL_NOT_DISABLED),
        (True, set(["cmdline"])),
    ),
    # RHEL7 disabled via sysctl
    (
        7,
        Case(CMDLINE_NOT_DISABLED, None, None, SYSCTL_DISABLED),
        (True, set(["sysctl"])),
    ),
    # RHEL7 disabled by both cmdline and sysctl
    (
        7,
        Case(CMDLINE_DISABLED, None, None, SYSCTL_DISABLED),
        (True, set(["cmdline", "sysctl"])),
    ),
    # RHEL7 with only uname provided
    (7, Case(None, None, None, None), (False, set())),
    # RHEL6 loaded not disabled
    (
        6,
        Case(None, LSMOD_LOADED, MODPROBE_NOT_DISABLED, SYSCTL_NOT_DISABLED),
        (False, set()),
    ),
    # RHEL6 not loaded but not disabled
    (
        6,
        Case(None, LSMOD_NOT_LOADED, MODPROBE_NOT_DISABLED, SYSCTL_NOT_DISABLED),
        (False, set()),
    ),
    # RHEL6 fake installed but loaded
    (6, Case(None, LSMOD_LOADED, MODPROBE_FAKE, SYSCTL_NOT_DISABLED), (False, set())),
    # RHEL6 not loaded, fake install commented
    (
        6,
        Case(None, LSMOD_NOT_LOADED, MODPROBE_FAKE_COMMENTED, SYSCTL_NOT_DISABLED),
        (False, set()),
    ),
    # RHEL6 loaded but disabled via modprobe
    (
        6,
        Case(None, LSMOD_LOADED, MODPROBE_DISABLED, SYSCTL_NOT_DISABLED),
        (True, set(["modprobe_disable"])),
    ),
    # RHEL6 not loaded, disabled via modprobe
    (
        6,
        Case(None, LSMOD_NOT_LOADED, MODPROBE_DISABLED, SYSCTL_NOT_DISABLED),
        (True, set(["modprobe_disable"])),
    ),
    # RHEL6 not loaded, disabled via fake install
    (
        6,
        Case(None, LSMOD_NOT_LOADED, MODPROBE_FAKE, SYSCTL_NOT_DISABLED),
        (True, set(["fake_install"])),
    ),
    # RHEL6 loaded but disabled by sysctl
    (
        6,
        Case(None, LSMOD_LOADED, MODPROBE_NOT_DISABLED, SYSCTL_DISABLED),
        (True, set(["sysctl"])),
    ),
    # RHEL6 not loaded, disabled by sysctl
    (
        6,
        Case(None, LSMOD_NOT_LOADED, MODPROBE_NOT_DISABLED, SYSCTL_DISABLED),
        (True, set(["sysctl"])),
    ),
    # RHEL6 disabled by modprobe and sysctl
    (
        6,
        Case(None, LSMOD_NOT_LOADED, MODPROBE_DISABLED, SYSCTL_DISABLED),
        (True, set(["sysctl", "modprobe_disable"])),
    ),
    # RHEL6 with lsmod but no modprobe
    (6, Case(None, LSMOD_LOADED, None, None), (False, set())),
    # RHEL6 with modprobe but no lsmod
    (6, Case(None, None, MODPROBE_DISABLED, None), (True, set(["modprobe_disable"]))),
    # RHEL6 with fake install but no lsmod (insufficient data)
    (6, Case(None, None, MODPROBE_FAKE, None), (False, set())),
    # RHEL6 with command line only
    (6, Case(CMDLINE_RHEL6_DISABLED, None, None, None), (True, set(["cmdline"]))),
]
...
def test_integration():
    for rhel, case, result in CASES:
        ...
        if case.modprobe is not None:
            context[ModProbe] = ModProbe(
                context_wrap(case.modprobe, path="/etc/modprobe.d/ipv6.conf")
            )
