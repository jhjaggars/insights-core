...
def test_1():
    ...
    conf1 = EtcJournaldConf(
        context_wrap(JOURNALD_CONF_1, path="/etc/systemd/journald.conf")
    )
    result = JournaldConfAll(conf1, None, None)
    assert result.active_settings_with_file_name["Storage"] == (
        "persistent",
        "/etc/systemd/journald.conf",
    )
    assert result.get_active_setting_value("Seal") == "no"
    assert result.get_active_setting_value_and_file_name("Seal") == (
        "no",
        "/etc/systemd/journald.conf",
    )
...
def test_2():
    ...
    conf2 = EtcJournaldConfD(
        context_wrap(JOURNALD_CONF_2, path="/etc/systemd/journald.conf.d/a.conf")
    )
    ...
    assert result.files_used_priority_order == [
        "/etc/systemd/journald.conf",
        "/etc/systemd/journald.conf.d/a.conf",
    ]
...
def test_3():
    ...
    conf3 = UsrJournaldConfD(
        context_wrap(JOURNALD_CONF_3, path="/usr/lib/systemd/journald.conf.d/a.conf")
    )
...
def test_4():
    ...
    assert result.get_active_setting_value_and_file_name("Compress") == (
        "no",
        "/usr/lib/systemd/journald.conf.d/a.conf",
    )
    assert result.get_active_setting_value("ForwardToConsole") == "yes"
    assert result.get_active_setting_value_and_file_name("ForwardToConsole") == (
        "yes",
        "/usr/lib/systemd/journald.conf.d/a.conf",
    )
...
def test_5():
    ...
    conf4 = EtcJournaldConfD(
        context_wrap(JOURNALD_CONF_4, path="/etc/systemd/journald.conf.d/b.conf")
    )
...
def test_6():
    ...
    conf5 = UsrJournaldConfD(
        context_wrap(JOURNALD_CONF_5, path="/usr/lib/systemd/journald.conf.d/b.conf")
    )
...
def test_9():
    ...
    conf2 = EtcJournaldConfD(
        context_wrap("", path="/etc/systemd/journald.conf.d/a.conf")
    )
    conf3 = UsrJournaldConfD(
        context_wrap("", path="/usr/lib/systemd/journald.conf.d/a.conf")
    )
    conf4 = EtcJournaldConfD(
        context_wrap("", path="/etc/systemd/journald.conf.d/b.conf")
    )
    conf5 = UsrJournaldConfD(
        context_wrap("", path="/usr/lib/systemd/journald.conf.d/b.conf")
    )
    result = JournaldConfAll(conf1, [conf2, conf4], [conf3, conf5])
    assert result.active_settings_with_file_name["Storage"] == (
        "persistent",
    ...
    assert result.files_used_priority_order == [
        "/etc/systemd/journald.conf"
    ]  # other files are empty and effectively not used
...
def test_10():
    ...
    conf3 = UsrJournaldConfD(
        context_wrap(None, path="/usr/lib/systemd/journald.conf.d/a.conf")
    )
