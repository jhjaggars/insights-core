...
@combiner(
    [Grub1Config, Grub2Config, Grub1EFIConfig, Grub2EFIConfig],
...
class GrubConf(object):
    ...
    def __init__(self, grub1, grub2, grub1_efi, grub2_efi, rpms, cmdline, sys_firmware):
    ...
    def get_grub_cmdlines(self, search_text=None):
        ...
        if search_text is None:
            ...
            return [
                entry
                for entry in self.grub.boot_entries
                if search_text in entry.cmdline
            ]
        return []
